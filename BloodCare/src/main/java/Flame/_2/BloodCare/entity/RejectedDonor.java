...
public class RejectedDonor {
    ...
    private String donateThroughCamp; // Store donor details as a JSON string or separate fields.
    ...
    public String getDonateThroughCamp() {
        return donateThroughCamp;
    }
